...
const $whatIsDOM = document.getElementById("que-es");
 ...
 let text=`
 <p>El Modelo de Objetos del Documento(<b><i>DOM-Document Object Model</i></b>) es una API para documentos HTML y XML
 </p>m
 <p>
 Éste provee una representacion estructural del documento, permitiendo modificar su contenido y presentación visual mediante código JS
 </p>
 <p>
 <mark>
...
console.log($cards.childNodes);//muestra nodos hijos
...
console.log($cards.closest("body"));//buscar el ancestro mas cercano
...
//si lo ejecutas con los "()"" se ejecutan al iniciar
